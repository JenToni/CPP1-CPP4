...
class Object {
 public:
  ...
  void rotateModel(double angle, int axis);
  void DegreesToRadians(double *degrees);
  void moveModel(double value, int axis);
  void scaleModel(double oldScale, double newScale);
