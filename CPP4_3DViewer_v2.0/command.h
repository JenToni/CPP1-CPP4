...
class Command : public QObject {
 ...
 public:
  ...
  void setRotationX(float x, bool GLWidgetConnect) noexcept;
  void setRotationY(float y, bool GLWidgetConnect) noexcept;
  void setRotationZ(float z) noexcept;
  tuple *getAngles() noexcept;
  float getScale() noexcept;
  void setScale(float s, float normalization, bool GLWidgetConnect) noexcept;
